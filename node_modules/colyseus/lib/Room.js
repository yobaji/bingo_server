...
class Room extends events_1.EventEmitter {
    ...
    send(client, message) {
        if (client.state === _1.ClientState.JOINING) {
    ...
    broadcast(message, options = {}) {
        ...
        const encodedMessage = (!(message instanceof Buffer))
            ? notepack_io_1.default.encode(message)
            : message;
        let numClients = this.clients.length;
        while (numClients--) {
            const client = this.clients[numClients];
            if (options.except !== client) {
                Protocol_1.send[Protocol_1.Protocol.ROOM_DATA](client, encodedMessage, false);
            }
        }
        return true;
    }
        ...
        if (numClients > 0) {
            ...
            while (numClients--) {
                ...
                if (reconnection) {
                    ...
                    client.close(Protocol_1.Protocol.WS_CLOSE_CONSENTED);
                }
            }
        }
        else {
    ...
    ['_onJoin'](client, req) {
        return __awaiter(this, void 0, void 0, function* () {
            client.state = _1.ClientState.JOINING;
            ...
            client.state = _1.ClientState.JOINED;
    ...
    allowReconnection(client, seconds = 15) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sessionId = client.sessionId;
            yield this._reserveSeat(sessionId, true, seconds, true);
            ...
            reconnection.
                then(() => {
                client.state = _1.ClientState.RECONNECTED;
                clearTimeout(this.reservedSeatTimeouts[sessionId]);
                cleanup();
            }).
                catch(() => {
    ...
    _onMessage(client, message) {
        ...
        if (message[0] === Protocol_1.Protocol.ROOM_DATA) {
            ...
            this._onLeave(client, Protocol_1.Protocol.WS_CLOSE_CONSENTED).then(() => client.close(Protocol_1.Protocol.WS_CLOSE_NORMAL));
        }
        else {
    ...
    _onLeave(client, code) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (success) {
                ...
                if (client.state !== _1.ClientState.RECONNECTED) {
