...
function setup(_presence, _driver, _processId) {
    presence = _presence || new LocalPresence_1.LocalPresence();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (room) {
            ...
            if (rejoinSessionId) {
                ...
                const [_, hasReservedSeat] = yield remoteRoomCall(room.roomId, 'hasReservedSeat', [rejoinSessionId]);
                if (hasReservedSeat) {
 ...
 */
function remoteRoomCall(roomId, method, args, rejectionTimeout = exports.REMOTE_ROOM_SHORT_TIMEOUT) {
    return __awaiter(this, void 0, void 0, function* () {
...
function createRoom(roomName, clientOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        room.listing = exports.driver.createInstance(Object.assign({ name: roomName, processId }, registeredHandler.getFilterOptions(clientOptions)));
        if (room.onCreate) {
            try {
        ...
        Debug_1.debugMatchMaking('spawning \'%s\', roomId: %s, processId: %s', roomName, room.roomId, processId);
...
function reserveSeatFor(room, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        Debug_1.debugMatchMaking('reserving seat. sessionId: \'%s\', roomId: \'%s\', processId: \'%s\'', sessionId, room.roomId, processId);
        let successfulSeatReservation;
        try {
            const [_, ok] = yield remoteRoomCall(room.roomId, '_reserveSeat', [sessionId, options]);
...
function cleanupStaleRooms(roomName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield presence.del(getHandlerConcurrencyKey(roomName));
...
function createRoomReferences(room, init = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield presence.sadd(room.roomName, room.roomId);
        if (init) {
            yield presence.subscribe(getRoomChannel(room.roomId), (message) => {
...
function awaitRoomAvailable(roomToJoin, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            const concurrency = (yield presence.incr(concurrencyKey)) - 1;
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    yield presence.decr(concurrencyKey);
                }
            }), concurrencyTimeout);
        }));
    });
...
function disposeRoom(roomName, room) {
    Debug_1.debugMatchMaking('disposing \'%s\' (%s) on processId \'%s\'', roomName, room.roomId, processId);
